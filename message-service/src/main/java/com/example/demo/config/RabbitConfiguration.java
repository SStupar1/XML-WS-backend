...
import com.example.demo.consumer.QueueConsumer;
...
public class RabbitConfiguration {
    ...
    public CachingConnectionFactory rabbitConnectionFactory(RabbitProperties config) throws Exception {
        ...
        connectionFactory.getRabbitConnectionFactory().setUri("amqps://bitueoca:f7enuQ3Bd4axqqADOFu6hlvrk0F5HpYX@bonobo.rmq.cloudamqp.com/bitueoca");
